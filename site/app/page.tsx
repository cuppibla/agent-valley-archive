...
const SERIES = "https://github.com/cuppibla/agent-valley-archive";
...
const DISTRICTS = [
  ...
  { id: "archive", img: "/world/zones/archive.jpg", chip: "04 · REMEMBER",
    name: "The Archive", href: "/w4", open: true, status: "OPEN" },
  ...
  return (
    <div className="wrap">
      <div style={{ display: "grid", gridTemplateColumns: "1.15fr 1fr", gap: 22, alignItems: "center",
        marginBottom: 26 }}>
        <div>
          <div className="eyebrow">AGENT 101 · CHAPTER FOUR</div>
          ...
          <p style={{ color: "var(--sub)", fontSize: 15, margin: 0, maxWidth: "40ch", lineHeight: 1.6 }}>
            Never make the visitor say it twice. Watch a tower remember.
          </p>
          <div style={{ display: "flex", gap: 10, marginTop: 18, alignItems: "center" }}>
            <Link href="/w4" style={{ textDecoration: "none", padding: "12px 26px", borderRadius: 13,
        ...
        <div style={{ borderRadius: 24, overflow: "hidden", border: "1px solid var(--line)",
          ...
          <img src="/world/w4/vesper-desk.jpg" alt="Vesper at the desk in the Archive" width="100%"
