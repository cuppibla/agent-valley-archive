#!/usr/bin/env bash
# The Archive — make a fresh billing-linked Google Cloud project for week four.
#
...
#
# A NEW PROJECT IS THE DEFAULT. Week four starts clean even when you already
...
# likely to belong to some other codelab as to weeks one, two or three — reusing
# it silently drops week four's resources into a stranger's project, and the
...
PREFIX="agent-valley-"
# Weeks one, two and three's ./setup_project.sh create "${PREFIX}NNNN" — four
...
say "Agent Valley · week four · project + billing"
